...
public class ClanListener extends SpigotModule<ClanManager> implements Listener {
    ...
    public void onClanInvite(ClanInviteEvent event) {
        ...
        clan.inform(true, "Clans", ChatColor.AQUA + player.getName() + ChatColor.GRAY + " invited " + ChatColor.YELLOW + target.getName() + ChatColor.GRAY + " to the Clan.", new UUID[] { player.getUniqueId() });
